...
internal class UserPanel extends Sprite
{
    ...
    public function UserPanel(view:MPRoomViewFFR, room:MPRoomFFR)
    {
        ...
        _name = new Text(this, 20, 0, room.name, 16);
        _name.setAreaParams(view.width - 85, 30);
    ...
    {
        _name.text = room.name ? room.name : "";
...
internal class OwnerEditPanel extends Sprite
{
    ...
    public function OwnerEditPanel(view:MPRoomViewFFR, room:MPRoomFFR)
    {
        ...
        _name = new BoxText(this, 20, 1, 280, 28);
        _name.field.y += 1;
        _name.borderAlpha = 0;
        _name.borderActiveAlpha = 0;
        ...
        // Draw
        this.graphics.lineStyle(1, 0xFFFFFF, 0.35);
        this.graphics.moveTo(_name.x, 1);
        this.graphics.lineTo(_name.x, _name.height + 1);
        this.graphics.moveTo(_name.x + _name.width, 1);
        this.graphics.lineTo(_name.x + _name.width, _name.height + 1);
