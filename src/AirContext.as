package
{
    ...
    public class AirContext
    {
        ...
        static public function loadFile(file:AirFile, callback:Function = null, context:LoaderContext = null):Loader {
            var loader:Loader = new Loader();
            loader.contentLoaderInfo.addEventListener(SecurityErrorEvent.SECURITY_ERROR, callback != null ? callback : e_fileError);
            loader.contentLoaderInfo.addEventListener(IOErrorEvent.IO_ERROR, callback != null ? callback : e_fileError);
